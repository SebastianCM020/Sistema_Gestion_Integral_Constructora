// fix_ps1.js - Genera generate_arch_v2_clean.ps1 con solo caracteres ASCII
const fs = require('fs');
const path = require('path');
const outPath = path.join(__dirname, 'docs', 'generate_arch_v2_clean.ps1');
...
fs.writeFileSync(outPath, script, { encoding: 'utf8' });
