...
export const moduleCatalog = [
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    helperText: 'Valide requerimientos nuevos antes de que pasen a revisión gerencial.',
    statusLabel: 'Disponible para su rol',
  },
  {
    id: 'change-orders',
    name: 'Órdenes de Cambio',
    description: 'Gestione solicitudes de ampliación de cantidades por rubro.',
    icon: ClipboardList,
...
const roleCatalog = {
  admin: {
    ...
    moduleIds: ['administration', 'projects', 'rubros', 'catalog', 'audit', 'reports', 'system-validations', 'technical-settings', 'requirements', 'change-orders'],
    quickActions: [
      ...
      { id: 'qa-admin-rubros', label: 'Abrir rubros and carga masiva', description: 'Cree rubros manuales o valide importaciones CSV por proyecto.', icon: Building2, actionType: 'admin-view', adminSection: 'rubros' },
  ...
  executive: {
    ...
    moduleIds: ['review', 'reports', 'payroll', 'accounting', 'requirements', 'change-orders'],
    quickActions: [
  ...
  accountant: {
    ...
    moduleIds: ['accounting-review', 'accounting', 'payroll', 'reports', 'change-orders'],
    quickActions: [
  ...
  resident: {
    ...
    moduleIds: ['progress', 'evidence', 'consumption', 'requirements', 'reports', 'change-orders'],
    quickActions: [
