...
export function EmptyReportsState({ title, description, actionLabel, onAction }) {
  return (
    <div className="rounded-[12px] border border-dashed border-[#D1D5DB] bg-[#F7F9FC] px-5 py-8 text-center">
