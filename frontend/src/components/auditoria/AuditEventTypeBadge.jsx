...
import { getAuditOperationMeta } from '../../utils/auditHelpers.js';
...
export function AuditEventTypeBadge({ operationType }) {
  const meta = getAuditOperationMeta(operationType);
